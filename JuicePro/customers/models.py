...
class Customer(models.Model):
    customer_id = models.AutoField(primary_key=True, verbose_name='Kliento nr.')
...
class Payment(models.Model):
    payment_id = models.AutoField(primary_key=True, verbose_name='Mokėjimo nr.')
    order_id = models.ForeignKey(Order, on_delete=models.CASCADE, verbose_name='Užsakymo nr.')
    customer = models.ForeignKey(Customer, on_delete=models.CASCADE, verbose_name='Klientas')
